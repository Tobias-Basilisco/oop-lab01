class TestComplexNum {
    public static void main(String[] args) {
      ...
      */
      ...
      /*10)*/      
      if(c3.equal(c1)){
        System.out.println("c3 e c1 sono uguali");
      } else {
        System.out.println("c3 e c1 non sono uguali");
      }

      if(c3.equal(c2)){
        System.out.println("c3 e c2 sono uguali");
      } else {
        System.out.println("c3 e c2 non sono uguali");
      }

      if(c3.equal(c4)){
        System.out.println("c3 e c4 sono uguali");
      } else {
        System.out.println("c3 e c4 non sono uguali");
      }
    }
}
